    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-[150] flex items-center justify-center p-4" onClick={onClose}>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
            <header className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10">
                <h2 className="text-lg font-normal text-gray-900 dark:text-gray-100">Create New Company</h2>
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
                <main className="p-6 space-y-8 overflow-y-auto">
                    <fieldset className="space-y-4">
                        <legend className="text-lg font-normal text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 pb-2 mb-4">Company Details</legend>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="companyName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Company Name</label>
                            ...
                            <div>
                                <label htmlFor="cisoName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">CISO Name</label>
                            ...
                            <div>
                                <label htmlFor="ceoName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">CEO Name</label>
                            ...
                            <div>
                                <label htmlFor="cioName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">CIO Name</label>
                            ...
                            <div>
                                <label htmlFor="ctoName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">CTO Name</label>
                            ...
                            <div>
                                <label htmlFor="cybersecurityOfficerName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Cybersecurity Officer</label>
                            ...
                            <div>
                                <label htmlFor="dpoName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Data Protection Officer (DPO)</label>
                            ...
                            <div>
                                <label htmlFor="complianceOfficerName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Compliance Officer</label>
                    ...
                    <fieldset className="space-y-4">
                        <legend className="text-lg font-normal text-gray-900 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700 pb-2 mb-4">Administrator Account</legend>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="adminName-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Full Name</label>
                            ...
                            <div>
                                <label htmlFor="adminEmail-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Email Address</label>
                            ...
                            <div>
                                <label htmlFor="adminPassword-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Password</label>
                            ...
                            <div>
                                <label htmlFor="adminConfirmPassword-modal" className="block text-sm font-normal text-gray-700 dark:text-gray-300">Confirm Password</label>
                                <div className="relative mt-1">
                ...
                <footer className="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 flex justify-end items-center gap-4 sticky bottom-0 border-t border-gray-200 dark:border-gray-700">
                    <button type="button" onClick={onClose} className="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-normal rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-500">Cancel</button>
                    <button type="submit" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-normal rounded-md text-white bg-teal-600 hover:bg-teal-700">Create Company</button>
                </footer>
            </form>
             <style>{`
            .input-style {
